...
public class HttpUtils {
    ...
    public String doGetAuth(String url, String usuario, String senha) throws IOException {
        return doGet(url, null, "UTF-8", usuario, senha);
    }
    ...
    public String doGet(String url, Map<String, String> params, String charset, String user, String password) throws IOException {
        String queryString = getQueryString(params);
        if (queryString != null && queryString.trim().length() > 0) {
            url += "?" + queryString;
        }
        ...
        try {
            ...
            conn.setRequestProperty("Authorization ", "basic " + IOUtils.convertToBase64(user, password));
    ...
    public String doPost(String url, Map<String, String> params, String charset, boolean retirarChave) throws IOException {
        if (retirarChave) {
            String queryString = getQueryString(params);
            queryString = StringUtils.getMapaSemChave(queryString);
